    ...
    useEffect(() => {
        const fetchArtists = async () => {
            try {
                ...
                setError(
                    err.response?.data?.message || "Failed to load artists."
                );
            } finally {
                setLoading(false);
            }
            ...
            <div className="my-5 container-fluid">
                <div className="artist-hero-image mb-5 p-5">
                    <div>
                        ...
                        <p className="lead">
                            Transform your ideas into art — hire a talented
                            tattoo artist today.
                        </p>
                        {/* Single Search Bar */}
                ...
                <h1 className="text-center mb-4 search-bar-heading">
                    Our Artists
                </h1>
